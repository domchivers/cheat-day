...
const CACHE = "cheatday-v4";
const ASSETS = ["./", "./index.html", "./styles.css?v=4", "./presets.js?v=4", "./app.js?v=4", "./vendor/zxing.min.js", "./manifest.webmanifest", "./icons/icon-192.png?v=2", "./icons/icon-512.png?v=2"];
