...
const CACHE = "cheatday-v1";
const ASSETS = ["./", "./index.html", "./styles.css?v=1", "./app.js?v=1", "./vendor/zxing.min.js", "./manifest.webmanifest", "./icons/icon-192.png", "./icons/icon-512.png"];
