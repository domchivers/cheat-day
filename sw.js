...
const CACHE = "cheatday-v3";
const ASSETS = ["./", "./index.html", "./styles.css?v=3", "./presets.js?v=3", "./app.js?v=3", "./vendor/zxing.min.js", "./manifest.webmanifest", "./icons/icon-192.png?v=2", "./icons/icon-512.png?v=2"];
