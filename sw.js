...
const CACHE = "cheatday-v2";
const ASSETS = ["./", "./index.html", "./styles.css?v=2", "./app.js?v=2", "./vendor/zxing.min.js", "./manifest.webmanifest", "./icons/icon-192.png?v=2", "./icons/icon-512.png?v=2"];
